...
{
    public class EstadisticasDatos2
    {
        private readonly Conexion conexion;

        public EstadisticasDatos2(Conexion conexion)
        {
        ...
        public int ObtenerTotalOperadoras()
        {
            ...
            {
                string query = "SELECT COUNT(*) FROM operadora2";
        ...
        public (string Nombre, int Total) ObtenerOperadoraConMasReservaciones()
        {
            using (var con = conexion.ObtenerConexion())
            {
                ...
                string query = @"
                    ...
                    JOIN operadora2 o ON o.id = r.IdOperadora
