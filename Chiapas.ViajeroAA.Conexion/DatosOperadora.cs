    ...
    public class DatosOperadora
    {
        ...
        string ladaa, string telefono, string representante, string correo, string identificacion, string fotoPath)
        {
            ...
            using (MySqlConnection connection = _conexion.ObtenerConexion())
            {
                ...
                string query = "INSERT INTO operadora (nombre_operadora, sitio_web, descripcion, direccion, lada, telefono, representante, email, identificacion, logo) " +
