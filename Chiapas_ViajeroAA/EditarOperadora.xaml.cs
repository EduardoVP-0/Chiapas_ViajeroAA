...
namespace Pagina_Principal
{
    ...
    public partial class EditarOperadora : Window
    {
        public EditarOperadora(int idOperadora)
        {
            ...
            var repositorio = new RepositorioOperadora();

            // Obtener los detalles de la operadora desde la base de datos
            VistaOperadora operadora = repositorio.ObtenerOperadoraPorId(idOperadora);
        ...
        private void Btn_Editar_Click(object sender, RoutedEventArgs e)
        {
            if (MessageBox.Show("¿Estás seguro de editar este registro?", "Confirmar", MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes)
            {
                ...
                RepositorioOperadora repo = new RepositorioOperadora();
                ...
                if (resultado)
                {
                    ...
                    Gestion_Operadora ventana = new Gestion_Operadora();
                    ventana.Show();
                    this.Close();
                }
                else
