...
{
    /// <summary>
    /// Lógica de interacción para Registros_Datos2.xaml
    /// </summary>
    public partial class Registros_Datos2 : Window
    {
        private ServicioDatos2 _Serviciodatos;
        private string rutaImagenSeleccionada = string.Empty;

        public Registros_Datos2()
        {
            InitializeComponent();
            _Serviciodatos = new ServicioDatos2(new DatosOperadora2());
        }
